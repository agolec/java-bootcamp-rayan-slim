...
public class Game {
    ...
    public Game(String arena) {
        ...
        if(arena == null || arena.isBlank()){
            throw new IllegalArgumentException("Arena should not be null or blank.");
        }
        this.arena = arena;
        this.date = LocalDate.now();
        this.formattedDate = this.date.format(DateTimeFormatter.ofPattern("dd/MM/yyyy"));
    }
    ...
    public void begin(Team home, Team away) {
        ...
        System.out.println
        (
        "\n - This matchup takes place at the " + this.arena + " arena on " + this.formattedDate.toString() + "." +
